...
def main():
    ...
    try:
        ...
        #クエリを定義
        sql = "select PROJECTID,URLID,PROJECTNAME,PROJECT_COMMENT,PROJECT_NAIYO,PROJECT_CRTUSER,USERAUTHFLG,CRTDATE,UPDDATE from T100_PROJECT order by PROJECTID ASC "
        #パラメータを定義
        args = ()
        #クエリを実行し、結果を取得
        ...
        #戻り値を作成
        json_service = {"json_CommonInfo":json_CommonInfo, "tuple_T100_projectList" : rows}
        return json_service
    #==例外処理==========================================================================================
